...
===============================================================================
    ...
    CONTENTS:
        ...
        Implementation of class MyJEGAOptimizer.

    NOTES:

        See notes of MyJEGAOptimizer.hpp.
...
*/
/** \file
 * \brief Contains the implementation of the MyJEGAOptimizer class.
 */
 ...
 */
class MyJEGAOptimizer::Evaluator :
 ...
 */
class MyJEGAOptimizer::EvaluatorCreator :
    ...
    public JEGA::FrontEnd::Driver
{
    ...
    */
    private:
	// AN: model will be required by the driver.
	// AI implementation will require access to inactive variables.
	Model &theModel;
    ...
    */
	...
	// AN: re-implemented to incorporate smart AI features.
        DesignOFSortSet
        PerformIterations(
    ...
    )
{
    ...
    MyJEGAOptimizer::Driver driver(pConfig, this->iteratedModel);
...
bool
MyJEGAOptimizer::accepts_multiple_points(
    ) const
{
    return true;
}
...
bool
MyJEGAOptimizer::returns_multiple_points(
    ) const
{
    return true;
}
...
void
MyJEGAOptimizer::initial_points(
...
void
MyJEGAOptimizer::LoadDakotaResponses(
...
//     Need to respect constraint ordering.
    ...
    // (see MyJEGAOptimizer::LoadTheConstraints()).
...
void
MyJEGAOptimizer::ReCreateTheParameterDatabase(
    )
{
    EDDY_FUNC_DEBUGSCOPE
...
void
MyJEGAOptimizer::LoadTheParameterDatabase(
    )
{
    EDDY_FUNC_DEBUGSCOPE
...
void
MyJEGAOptimizer::LoadAlgorithmConfig(
    ...
    )
{
    ...
    if(this->methodName == Dakota::MOGA)
...
void
MyJEGAOptimizer::LoadProblemConfig(
...
void
MyJEGAOptimizer::LoadTheDesignVariables(
    JEGA::FrontEnd::ProblemConfig& pConfig
    )
{
    EDDY_FUNC_DEBUGSCOPE
...
void
MyJEGAOptimizer::LoadTheObjectiveFunctions(
    JEGA::FrontEnd::ProblemConfig& pConfig
    )
{
    EDDY_FUNC_DEBUGSCOPE
...
void
MyJEGAOptimizer::LoadTheConstraints(
    JEGA::FrontEnd::ProblemConfig& pConfig
    )
{
    EDDY_FUNC_DEBUGSCOPE
...
void
MyJEGAOptimizer::GetBestSolutions(
...
void
MyJEGAOptimizer::GetBestMOSolutions(
    const JEGA::Utilities::DesignOFSortSet& from,
    const JEGA::Algorithms::GeneticAlgorithm& theGA,
    std::multimap<RealRealPair, JEGA::Utilities::Design*>& designSortMap
    )
...
void
MyJEGAOptimizer::GetBestSOSolutions(
    const JEGA::Utilities::DesignOFSortSet& from,
    const JEGA::Algorithms::GeneticAlgorithm& theGA,
    std::multimap<RealRealPair, JEGA::Utilities::Design*>& designSortMap
    )
...
JEGA::DoubleMatrix
MyJEGAOptimizer::ToDoubleMatrix(
        ...
        _iod(iod)
{
    ...
    // MyJEGAOptimizer now makes use of the JEGA front end core project to run
    ...
    // of how many MyJEGAOptimizers are used.
    ...
    JEGAIFLOG_II_G_F(!JEGA::FrontEnd::Driver::IsJEGAInitialized(), this,
        text_entry(lfatal(), "MyJEGAOptimizer Error: Unable to initialize JEGA")
        );
...
*/
void
MyJEGAOptimizer::Evaluator::SeparateVariables(
    const Design& from,
    RealVector& intoCont,
    IntVector&  intoDiscInt,
    RealVector& intoDiscReal,
    ...
    ) const
{
    ...
    // order laid out in MyJEGAOptimizer::LoadTheDesignVariables.  We will split
...
void
MyJEGAOptimizer::Evaluator::RecordResponses(
    const RealVector& from,
    Design& into
    ) const
{
...
bool
MyJEGAOptimizer::Evaluator::Evaluate(
    DesignGroup& group
    )
{
    EDDY_FUNC_DEBUGSCOPE
...
// AI implementation will be here...

DesignOFSortSet
MyJEGAOptimizer::Driver::PerformIterations(GeneticAlgorithm* theGA)
{
...
bool
MyJEGAOptimizer::Driver::PerformNextIteration(GeneticAlgorithm* theGA)
{
    EDDY_FUNC_DEBUGSCOPE
