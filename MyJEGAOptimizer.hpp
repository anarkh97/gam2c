...
===============================================================================
    ...
    CONTENTS:
        ...
        Definition of class MyJEGAOptimizer.
...
*/
/** \file
 * \brief Contains the definition of the MyJEGAOptimizer class.
 */
...
===============================================================================
*/
#ifndef MY_DAKOTA_JEGAOPTIMIZER_H
#define MY_DAKOTA_JEGAOPTIMIZER_H
    ...
    public Dakota::Optimizer
{
    ...
    */
    protected:
         ...
         *
         * This should be called from the MyJEGAOptimizer constructor since it
        ...
        GetBestSolutions(
  	    const JEGA::Utilities::DesignOFSortSet& from,
            ...
            std::multimap<Dakota::RealRealPair, JEGA::Utilities::Design*>& designSortMap
            );
        ...
        JEGA::DoubleMatrix
        ToDoubleMatrix(
            const Dakota::VariablesArray& variables
            ) const;
    ...
    */
    public:
         ...
         *            and run by this MyJEGAOptimizer.
         */
        virtual
        void
        initial_points(
            const Dakota::VariablesArray& pts
            );

        /**
         * \brief Overridden to return the collection of initial points for the
         *        JEGA algorithm created and run by this MyJEGAOptimizer.
         *
         * \return The collection of initial points for the JEGA algorithm
         *         created and run by this MyJEGAOptimizer.
         */
        virtual
        const Dakota::VariablesArray&
        initial_points(
            ) const;
    ...
    */
    public:
        ...
        /// Constructs a MyJEGAOptimizer class object.
        /**
...
class MyJEGATraits: public Dakota::TraitsBase
{
  public:
...
===============================================================================
*/
#endif // MY_DAKOTA_JEGAOPTIMIZER_H
